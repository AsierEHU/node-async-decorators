import { cacheWithDefaultOptions } from "../src/cachefy"
import { LocalCacheStorage } from "../src/cachefy/dataAccess/cacheStorage"
import { uniqueNumber, mockFunction, mockErrorFunction, mockNoParamsUniqueFunction, mockObject, wait } from "./utils"
...
describe("Cache Test (Default config)", () => {
    ...
    test("Proxy object with cache works", async () => { //TODO: mejorar

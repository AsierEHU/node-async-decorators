...
export type ParallelOptionsRequired = ParallelOptions & Pick<ParallelConfiguration, "concurrency">
...
export const parallelWithDefaultOptions = (options: ParallelOptionsRequired) => {

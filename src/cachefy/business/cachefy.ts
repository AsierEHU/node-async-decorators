...
import { ArrayType, BasicType, Context, DictionaryType, GenericAsyncFunction, Key } from "../../common/business/util";
 ...
 * Implementation
 */
export function cachefy<T extends CacheFunc>(asyncFunc: T, conf: CacheConfiguration): T {
    ...
    cachefyedFunction = batchfy(cachefyedFunction, { context: conf.context, contextKey: conf.contextKey }) //TODO: How to inject key? option like share key?
